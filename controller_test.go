...
import (
	...
	samplecontroller "demo-k8s-controller/pkg/apis/samplecontroller/v1alpha1"
	"demo-k8s-controller/pkg/client/clientset/versioned/fake"
	informers "demo-k8s-controller/pkg/client/informers/externalversions"
)
